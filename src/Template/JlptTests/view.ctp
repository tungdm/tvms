...
$this->assign('title', 'Kì thi JLPT ' . $jtest->test_date . ' - Thông tin chi tiết');
?>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-6 col-sm-6 col-xs-12" for="level"><?= __('Trình độ') ?>: </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-control form-control-view col-md-7 col-xs-12">
                                <?= h($jtest->level) ?>
                            </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-6 col-sm-6 col-xs-12" for="status"><?= __('Trạng thái') ?>: </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-control form-control-view col-md-7 col-xs-12">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-6 col-sm-6 col-xs-12" for="created_by"><?= __('Người tạo') ?>: </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-control form-control-view col-md-7 col-xs-12">
                                <?= $jtest->created_by_user ? $jtest->created_by_user->fullname : 'N/A' ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-6 col-sm-6 col-xs-12" for="created"><?= __('Thời gian khởi tạo') ?>: </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-control form-control-view col-md-7 col-xs-12">
                                <?= h($jtest->created) ?>
                            </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-6 col-sm-6 col-xs-12" for="modified_by"><?= __('Người sửa cuối') ?>: </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-control form-control-view col-md-7 col-xs-12">
                                <?= $jtest->modified_by_user ? $jtest->modified_by_user->fullname : 'N/A' ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-6 col-sm-6 col-xs-12" for="modified"><?= __('Thời gian sửa cuối') ?>: </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-control form-control-view col-md-7 col-xs-12">
                                <?= h($jtest->modified) ?>
                            </div>
                    ...
                    <table class="table table-bordered custom-table span-table">
                        <thead>
                            <tr>
                                ...
                                <?php foreach ($jtest->jlpt_contents as $key => $value): ?>
                                    <?php 
                        ...
                        <tbody>
                            <?php foreach ($jtest->students as $key => $value): ?>
                                ...
                                <tr class="row-score">
                                    ...
                                    <td class="cell">
                                        <?php if ($value->_joinData->result == 'Y'): ?>
                                            <strong><?= h($jlptResult[$value->_joinData->result]) ?></strong>
                                        <?php else: ?>
                                            <?= $value->_joinData->result ? h($jlptResult[$value->_joinData->result]) : 'N/A' ?>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
