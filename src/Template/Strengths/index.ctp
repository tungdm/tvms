...
$this->Html->script('strength.js', ['block' => 'scriptBottom']);
...
$this->assign('title', 'Quản lý chuyên môn');
?>

<?php $this->start('content-header'); ?>
    <h1><?= __('QUẢN LÝ CHUYÊN MÔN') ?></h1>
    <ol class="breadcrumb">
        <li>
            <?= $this->Html->link(
        ...
        <li class="active">Danh sách chuyên môn</li>
    </ol>
<?php $this->end(); ?>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="box">
            ...
            <?= $this->Form->create(null, [
                ...
                'url' => ['controller' => 'Strengths', 'action' => 'index'],
                'type' => 'get',
                'id' => 'filter-form'
                ]) ?>
            <div class="box-body table-responsive">
                <div class="overlay hidden" id="list-strengths-overlay">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="nameVnCol">
                                <?= $this->Paginator->sort('name', 'Chuyên môn (VN)')?>
                            </th>
                            <th scope="col" class="nameJpCol">
                                <?= $this->Paginator->sort('name_jp', 'Chuyên môn (JP)')?>
                            </th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="col-md-3 nameVnCol">
                                <?= $this->Form->control('strength_name', [
                                    'label' => false,
                                    'class' => 'form-control col-md-7 col-xs-12',
                                    'value' => $query['strength_name'] ?? ''
                                    ]) 
                                ?>
                            </td>
                            <td class="col-md-3 nameJpCol">
                                <?= $this->Form->control('strength_name_jp', [
                                    'label' => false,
                                    'class' => 'form-control col-md-7 col-xs-12',
                                    'value' => $query['strength_name_jp'] ?? ''
                                    ]) 
                                ?>
                            </td>
                        ...
                        <?php else: ?>
                            <?php foreach ($strengths as $strength): ?>
                                <?php $counter++ ?>
                                <tr>
                                    <td class="cell text-center <?= $strength->del_flag ? 'deletedRecord' : '' ?>"><?= $counter ?></td>
                                    <td class="cell nameVnCol">
                                        <a href="javascript:;" onclick="viewStrength(<?= $strength->id ?>)"><?= h($strength->name) ?></a>
                                    </td>
                                    <td class="cell nameJpCol"><?= h($strength->name_jp) ?></td>
                                    <td class="cell createdByCol">
                                        <?= !empty($strength->created_by_user) ? h($strength->created_by_user->fullname) : 'N/A' ?>
                                    </td>
                                    <td class="cell modifiedByCol">
                                        <?= !empty($strength->modified_by_user) ? h($strength->modified_by_user->fullname) : 'N/A' ?>
                                    </td>
                                    <td class="actions cell">
                                        <div class="btn-group">
                                            ...
                                            <ul role="menu" class="dropdown-menu">
                                                <li>
                                                    <a href="javascript:;" onClick="viewStrength(<?= $strength->id ?>)">
                                                        <i class="fa fa-info-circle" aria-hidden="true"></i> Chi tiết
                                                    </a>
                                                </li>
                                                <?php if ($permission == 0): ?>
                                                    <?php if ($strength->del_flag): ?>
                                                        <li>
                                                            <?= $this->Form->postLink('<i class="fa fa-undo" aria-hidden="true"></i> Phục hồi', 
                                                            ['action' => 'recover', $strength->id], 
                                                            [
                                                                'escape' => false, 
                                                                'confirm' => __('Bạn có chắc chắn muốn phục hồi chuyên môn {0}?', $strength->name)
                                                            ]) ?>
                                                        </li>
                                                    <?php else: ?>
                                                        <li>
                                                            <a href="javascript:;" onClick="showEditStrengthModal('<?= $strength->id ?>')">
                                                            <i class="fa fa-edit"></i> Sửa</a>
                                                        </li>
                                                        <li>
                                                            <?= $this->Form->postLink('<i class="fa fa-trash" aria-hidden="true"></i> Xóa', 
                                                                ['action' => 'delete', $strength->id], 
                                                                [
                                                                    'escape' => false, 
                                                                    'confirm' => __('Bạn có chắc chắn muốn xóa chuyên môn {0}?', $strength->name)
                                                                ]) ?>
                                                        </li>
                                                    <?php endif; ?>
                                                <?php endif; ?>
...
<div class="modal fade" id="add-strength-modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">THÊM MỚI CHUYÊN MÔN</h4>
            </div>
            <div class="modal-body">
                <?= $this->Form->create(false, [
                    'class' => 'form-horizontal form-label-left', 
                    'id' => 'add-strength-form', 
                    'data-parsley-validate' => '',
                    'url' => ['controller' => 'Strengths', 'action' => 'add'],
                    'templates' => [
                        'inputContainer' => '{{content}}'
                        ]
                    ]) ?>
                <div class="form-group">
                    <label class="control-label col-md-4 col-sm-5 col-xs-12" for="name"><?= __('Chuyên môn (VN)') ?></label>
                ...
                <div class="form-group">
                    <label class="control-label col-md-4 col-sm-5 col-xs-12 optional" for="name_jp"><?= __('Chuyên môn (JP)') ?></label>
                    <div class="col-md-7 col-sm-5 col-xs-12">
...
<div class="modal fade" id="edit-strength-modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="overlay hidden" id="add-modal-overlay">
                <i class="fa fa-refresh fa-spin"></i>
            ...
            <div class="modal-body">
                <?= $this->Form->create(false, [
                    'class' => 'form-horizontal form-label-left', 
                    'id' => 'edit-strength-form', 
                    'data-parsley-validate' => '',
                    'url' => ['controller' => 'Strengths', 'action' => 'edit'],
                    'templates' => [
                        'inputContainer' => '{{content}}'
                        ]
                    ]) ?>
                <?= $this->Form->unlockField('id'); ?>
                <?= $this->Form->hidden('id', ['id' => 'edit-strength-id']) ?>
                <div class="form-group">
                    <label class="control-label col-md-4 col-sm-5 col-xs-12" for="name"><?= __('Chuyên môn (VN)') ?></label>
                    <div class="col-md-7 col-sm-5 col-xs-12">
                        <?= $this->Form->control('name', [
...
<div id="view-strength-modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">THÔNG TIN CHUYÊN MÔN</h4>
            </div>
            <div class="modal-body">
                <div class="form-horizontal form-label-left">
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-control form-control-view col-md-7 col-xs-12">
                                <span id="view-strength-name"></span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-control form-control-view col-md-7 col-xs-12">
                                <span id="view-strength-name-jp"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-control form-control-view col-md-7 col-xs-12">
                                <span id="view-strength-created-by"></span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-control form-control-view col-md-7 col-xs-12">
                                <span id="view-strength-created"></span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group modified">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-control form-control-view col-md-7 col-xs-12">
                                <span id="view-strength-modified-by"></span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group modified">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-control form-control-view col-md-7 col-xs-12">
                                <span id="view-strength-modified"></span>
                            </div>
                        </div>
                    </div>
                </div>
